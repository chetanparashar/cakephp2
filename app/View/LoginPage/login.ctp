...
echo $this->Html->para('text-red', isset($authMessage) ? $authMessage : '', array('style' => 'text-align:center'));
echo $this->Form->create('Loginage', array('url' => array('controller' => 'LoginPage', 'action' => 'login'), 'target' => '_self'));
